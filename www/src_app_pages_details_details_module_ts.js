...
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/fire/auth */ 7759);
...
class DetailsPage {
  constructor(overlay, authy, authService, avatar, router, actionSheetController, alertController, imageUploadService,
  // Inject the service
  loadingController) {
    ...
    return (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const actionSheet = yield _this2.actionSheetController.create({
        ...
        buttons: [{
          ...
          icon: 'camera',
          handler: () => {
            _this2.changeImage(_capacitor_camera__WEBPACK_IMPORTED_MODULE_1__.CameraSource.Camera);
          }
        }, {
          text: 'Gallery',
          icon: 'images',
          handler: () => {
            _this2.changeImage(_capacitor_camera__WEBPACK_IMPORTED_MODULE_1__.CameraSource.Photos);
          }
        }, {
          text: 'File',
          icon: 'document',
  ...
  selectFile() {
    ...
    return (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      input.onchange = /*#__PURE__*/function () {
        var _ref = (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event) {
          const file = event.target.files[0];
          if (file) {
            const reader = new FileReader();
            reader.onload = /*#__PURE__*/function () {
              var _ref2 = (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (e) {
                const image = {
                  base64String: e.target.result.split(',')[1]
                };
                const result = yield _this3.avatar.uploadImage(image, _this3.avatar.profile.uid);
                if (!result) {
                  ...
                  _this3.imageUrl = result; // Ensure imageUrl is updated
  ...
  reauthenticateWithPhoneNumber() {
    ...
    return (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return new Promise( /*#__PURE__*/function () {
        var _ref3 = (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
          try {
            ...
            const recaptchaVerifier = new _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__.RecaptchaVerifier(recaptchaContainerId, {}, _this4.authy);
            ...
            try {
              ...
              verificationResult = yield (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_9__.signInWithPhoneNumber)(_this4.authy, phoneNumber, recaptchaVerifier);
              console.log('Verification result:', verificationResult);
            } catch (error) {
              console.error('Error during signInWithPhoneNumber', error);
              _this4.overlay.showAlert('Error', 'An error occurred during phone number sign-in');
              reject(error);
              return;
            }
            ...
            const alert = yield _this4.alertController.create({
              ...
              buttons: [{
                ...
                text: 'Verify',
                handler: function () {
                  var _ref4 = (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data) {
            ...
            _this4.overlay.showAlert('Error', error.message || 'An error occurred during phone re-authentication');
            reject(error);
          }
        });
  ...
  updateProfile() {
    ...
    return (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        const user = _this5.authy.currentUser;
        if (user) {
          ...
          yield (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_9__.updateEmail)(user, _this5.form.value.email);
          ...
          yield _this5.avatar.createUser(`${_this5.form.value.fullname} ${_this5.form.value.lastname}`, _this5.form.value.email, _this5.imageUrl, user.phoneNumber, user.uid);
        ...
        if (e.code === 'auth/email-already-in-use') {
          _this5.overlay.showAlert('Error', 'The email address is already in use by another account.');
        } else if (e.code === 'auth/requires-recent-login') {
          _this5.reauthenticateWithPhoneNumber();
        } else {
          _this5.overlay.showAlert('Error', e.message || 'An error occurred');
        }
      }
    })();
  }
  signInWithGoogle() {
    ...
    return (0,c_Users_USER_Downloads_IONIC_PROJECTS_myRider_20240524T040505Z_001_myRider_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        ...
        const result = yield (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_9__.signInWithPopup)(_this6.authy, provider);
        const user = result.user;
        if (user) {
          _this6.imageUrl = user.photoURL || ''; // Update imageUrl with photoURL from Google
